...
class TransferArtwork extends Component {
  ...
  render() {
    ...
    return (
      <div id="transferArtworkModal" className="modal fade transfer-artwork-modal" tabIndex="-1" role="dialog" aria-labelledby="transferArtwork" aria-hidden="true" centered>
