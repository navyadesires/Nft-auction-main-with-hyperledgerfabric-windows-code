          ...
          return <div id={"nft-" + idx} key={idx} className={"card artwork-card mb-4 " + (isAuctionClosed ? 'artwork-card-disabled' : '')}>
            ...
            <div className="card-body">
              ...
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="btn-group">
                  {nft.nftStatus === 'INITIAL' && <button onClick={() => this.props.handleClick(id, nft.nftId, idx)} type="button" className="btn btn-sm btn-outline-success btn-wrapper" data-toggle="modal" data-target=".submit-artwork-auction-modal">Submit for Auction</button>}
