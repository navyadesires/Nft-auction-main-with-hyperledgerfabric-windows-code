...
import { SITE_MOURILOGO, SITE_NAME } from "../services/Constants";
    ...
    return (
      <div className="login-form vh-100 d-flex text-center">
        <form className="form-signin shadow" onSubmit={this.handleSubmit}>
          ...
          <input
            type="password"
            className="form-control mt-3 sub-title"
            name="password"
          ...
          />
          <button
            className="btn btn-primary btn-block my-4 sign-in-btn"
            type="submit"
