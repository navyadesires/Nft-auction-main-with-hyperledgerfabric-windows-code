...
import {SITE_NAME, SITE_MOURILOGO } from '../services/Constants';
      ...
      <div className="register-form vh-100 d-flex text-center">
        <form className="form-create-account shadow" id="formAccount" onSubmit={this.handleSubmit} noValidate>
          <div className="d-flex justify-content-center align-items-center">
            <img className="mb-4" src={SITE_MOURILOGO} alt="{SITE_NAME}" width="" height="75" />
          </div>
          <div className="row">
            <div className="col-md-12 mb-3">
              <label className='label-title' htmlFor="username">Username</label>
              <input type="text" className="form-control sub-title" id="username" placeholder='Enter Username' name="userID" value={this.state.user.userID || ''} onChange={this.handleChange} onClick={this.handleChange} required />
              <div className="text-danger">{this.state.formErrors.userID}</div>
            </div>
            <div className="col-md-12 mb-3">
              <label className ="label-title" htmlFor="password">Password</label>
              <input type="password" className="form-control sub-title" id="password" name="password" placeholder="Enter Password" onChange={this.handleChange} onClick={this.handleChange} required />
              <div className="text-danger">{this.state.formErrors.password}</div>
            </div>
            <div className="col-md-12 mb-3">
              <label className ="label-title" htmlFor="confirm_password">Confirm Password</label>
              <input type="password" className="form-control sub-title" id="confirm_password" name="confirm_password" placeholder='Enter Confirm Password' onChange={this.handleChange} onClick={this.handleChange} required />
          ...
          <div className="row">
            <div className="col-md-6 mb-3">
              ...
              <input type="text" className="form-control sub-title" placeholder="Enter Name" id="name" name="name" value={this.state.user.name || ''} onChange={this.handleChange} onClick={this.handleChange} required />
              <div className="text-danger">{this.state.formErrors.name}</div>
            </div>
            <div className="col-md-6 mb-3">
              <label className ="label-title" htmlFor="email">Email Address</label>
              <input type="email" className="form-control sub-title" id="email" name="email" placeholder='Enter Email' value={this.state.user.email || ''} onChange={this.handleChange} onClick={this.handleChange} required />
              <div className="text-danger">{this.state.formErrors.email}</div>
            </div>
          </div>
          <div className="row">
            <div className="col-md-6 mb-3">
              <label className ="label-title" htmlFor="phone">Phone</label>
              <input type="tel" className="form-control sub-title" id="phone" name="phone" placeholder='Enter Phone Number' value={this.state.user.phone || ''} onChange={this.handleChange} onClick={this.handleChange} required />
              <div className="text-danger">{this.state.formErrors.phone}</div>
            </div>
            <div className="col-md-6 mb-3">
              <label className ="label-title" htmlFor="address">Address</label>
              <input type="text" className="form-control sub-title" id="address" name="address" placeholder='Enter Address' value={this.state.user.address || ''} onChange={this.handleChange} onClick={this.handleChange} required />
          ...
          <div className="row">
            <div className="col-md-12 mb-3">
              <label className ="label-title" htmlFor="paymentID">Payment ID</label>
              <input type="text" className="form-control sub-title" id="paymentID" name="paymentID" placeholder='Enter Payment Id' value={this.state.user.paymentID || ''} onChange={this.handleChange} onClick={this.handleChange} required />
              <div className="text-danger">{this.state.formErrors.paymentID}</div>
            </div>
          </div>
          <button className="btn btn-primary btn-block my-3 signup-button" type="submit" disabled={this.state.isValidForm && this.state.formTouched ? false : true}>
            Sign Up
